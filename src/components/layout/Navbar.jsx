...
export default function Navbar() {
  ...
  return (
    <nav className={`px-[11%] fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-slate-100/200 backdrop-blur-md border-b border-white/10 py-4' : 'bg-transparent py-6'}`}>
      <div className="container mx-auto px-6 flex justify-between items-center">
        <div className="text-2xl font-bold tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 to-purple-600 cursor-pointer" onClick={() => handleNavClick('hero')}>
          SJ.
        </div>
